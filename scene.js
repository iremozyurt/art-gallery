...
function init() 
{
	...
	createObjectOBJ("objects/berke_sword.obj", -300, 150, -450, 50, [90, 90, 0], false);

	createArtTable(-100, 50, -450);
	createObjectOBJ("objects/statue_head.obj", -100, 160, -450, 50, [0, 0, 0], false);


	createArtTable(100, 50, -450);
	createObjectOBJ("objects/12329_Statue_v1_l3.obj", 100, 85, -450, 0.4, [-90, 0, 0], false);

	createArtTable(300, 50, -450);
	createObjectOBJ("objects/berke_kask.obj", 300, 100, -450, 10, [0, 90, 0], false);


	createArtTable(-300, 50, 450);
	createObjectOBJ("objects/12338_Statue_v1_L3.obj", -300, 100, 450, 1, [-90, 0, -180], true);

	createArtTable(-100, 50, 450);
	createObjectOBJ("objects/sword2.obj", -100, 50, 450, 122, [0, 0, 0], false);

	createArtTable(100, 50, 450);
	createObjectOBJ("objects/shield.obj", 100, 150, 450, 30, [-90, 180, 0], false);


	createArtTable(300, 50, 450);
	createObjectOBJ("objects/Vases.obj", 290, 100, 450, 65, [0, 90, 0], false);
